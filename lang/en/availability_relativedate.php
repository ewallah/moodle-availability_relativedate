...
$string['day'] = 'day';
$string['days'] = 'days';
$string['defaultdwm'] = 'time';
$string['defaultnumber'] = 'number';
$string['defaults'] = 'Default values';
$string['defaultstart'] = 'relative to';
...
$string['hour'] = 'hour';
$string['hours'] = 'hours';
$string['maxnumber'] = 'Maximum number to use';
$string['maxnumber_help'] = 'Display users numbers from 1 to ...
This value has to be higher than 59 and lower than 10000.';
