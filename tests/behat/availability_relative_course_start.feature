...
Feature: availability relative course startdate
  ...
  Scenario: Test start date condition
    ...
    Then I should see "1 day after course start date" in the "region-main" "region"
    ...
    And I should not see "1 day after course start date" in the "region-main" "region"
